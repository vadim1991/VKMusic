...
public class VKApiURLs {
    ...
    public static final String USER_GENERAL_INFO_URL = "https://api.vk.com/method/users.get?uids=%s&fields=uid,first_name,last_name,nickname,screen_name,sex,photo_200&access_token=%s";

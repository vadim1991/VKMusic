...
(function ($, undefined) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function (media) {
            ...
            listItem +=
                "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" +
                "<span class='track-play'><i class='icon-play'></i></span>" +
                "<span class='track-title'><span class='jp-title'>" + media.title + "</span>" + (media.artist ? " <span class='jp-artist'>by " + media.artist + "</span>" : "") + "</span>" +
                "</a>" +
                (media.added ? '<a id="' + media.owner_id + '_' + media.aid + '" class="add tips" href="#' + media.aid + '" title="ADD"><i class="icon-plus-squared"></i></a>' : "") +
                (media.soundcloud ? '<a id="' + media.owner_id + '_' + media.aid + '" class="soundcloud tips" href="#' + media.aid + '" title="SHARE"><i class="icon-soundcloud"></i></a>' : "") +
                (media.itunes ? '<a class="itunes tips" href="' + media.itunes + '" title="ITUNES" target="_blank"><i class="icon-itunes"></i></a>' : "") +
                (media.mp3 ? '<a download class="download tips" href="' + media.mp3 + '" title="DOWNLOAD" target="_blank"><i class="icon-download"></i></a>' : "");
